...
public class ln7_Exercises_roots extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            setContentView(R.layout.ln7_activity_roots_exercises);

        } else if (orientation == Configuration.ORIENTATION_LANDSCAPE) {

            setContentView(R.layout.ln7_land_activity_roots_exercises);
        }
    ...
    public void getRoots(){
        // get all exercises
        exerciseList = db.getAllExercisesRoots_fr();
    }
    ...
    public void createButtons(){
        ...
        goToHome.setOnClickListener((new View.OnClickListener() {
            public void onClick (View v) {
                Intent homeintent = new Intent(ln7_Exercises_roots.this, EquMainActivity.class);
        ...
        goToExerciseGr.setOnClickListener((new View.OnClickListener() {
            public void onClick (View v) {
                Intent exercisegrIntent = new Intent(ln7_Exercises_roots.this, ln7_ExerciseGroups.class);
    ...
    public void correctAnswer () {
        ...
        //errorText.setTextColor(getResources().getColor(R.color.correct));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item){
        ...
        switch (item.getItemId()) {
            ...
            case R.id.navi_Home:
                MenuIntents = new Intent(ln7_Exercises_roots.this, EquMainActivity.class);
                startActivity(MenuIntents);
                return true;

            case R.id.navi_Excerices:
                MenuIntents = new Intent(ln7_Exercises_roots.this, ln7_ExerciseGroups.class);
                startActivity(MenuIntents);
                return true;

            case R.id.navi_Theory:
                MenuIntents = new Intent(ln7_Exercises_roots.this, ln7_FracTheory.class);
                startActivity(MenuIntents);
                return true;
